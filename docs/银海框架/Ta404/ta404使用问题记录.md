...
### ta404-component-security-session
...
4. 框架默认是不开启spring session的，如果需要开启，将第三步的注释打开即可
5. 注意事项：

- 前后台开发模式下，如果是在本机，则前台的basePath地址如果配置的是localhost，则只能用localhost访问，不能用127.0.0.1，反之亦然。
